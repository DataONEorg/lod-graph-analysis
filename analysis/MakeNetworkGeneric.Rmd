...
```{r setup}
knitr::opts_knit$set(root.dir = '~/graph_analysis')
library(igraph)
```
...
save(edge_list, file = "code/path_name/edge_list.Rdata")
```
...
save(datasets_graph, file = "code/path_name/datasets_graph.Rdata")
```
...
```{r gephi edge list}
write.table(get.edgelist(datasets_graph), file = "code/path_name/gephi_edge_list.csv", row.names = FALSE, col.names = c("Source", "Target"), sep=",")
```
...
save(stats_df,
     file = "code/path_name/network_statistics.Rdata")
write.csv(stats_df,
     file = "code/path_name/network_statistics.csv", row.names = FALSE)
```
...
save(attribute_df, file = "code/path_name/dataset_attributes.Rdata")
write.csv(attribute_df, file = "code/path_name/dataset_attributes.csv", row.names = FALSE)
