...
```{r gephi edge list}
write.table(get.edgelist(datasets_graph), file = "code/ADC_datasets_final/gephi_edge_list.csv", row.names = FALSE, col.names = c("Source", "Target"), sep=",")
```
...
## Add URLs for datasets to attributes list for Gephi
...
write.csv(attribute_df_gephi,
          file = "code/ADC_datasets_final/gephi_dataset_attributes.csv", row.names = FALSE)
rm(attribs)
```
